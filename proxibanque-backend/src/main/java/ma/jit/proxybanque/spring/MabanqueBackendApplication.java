...
public class MabanqueBackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Employer g1 = new Gerant("HAMZA", "LAARICHI", "hamza", bcryptEncoder.encode("pass"), "hamza@gmail.com", "Oujda LOT Douhi");
		g1.setAgence(a1);
		Employer g2 = new Gerant("Mustapha", "Hantali", "hantali", bcryptEncoder.encode("pass"), "riahi@gmail.com", "Rabat, EL Ouartassi");
		g2.setAgence(a2);
		
		this.employeDao.save(g1);
		this.employeDao.save(g2);
		
		Employer e1 =new Conseiller("Elwahabi", "mohamed", "med", bcryptEncoder.encode("pass"), "test@gmail.com", "oujda");
		e1.setAgence(a1);
